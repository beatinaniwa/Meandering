...
function reloadData(sportName, methodName, summaryName) {
    var filebase = "/data/tweet." + sportName + "." + methodName + ".all.";
    ...
    d3.json("/data/olympics." + sportName + ".times.json", function(events) {
...
setupControl("sports", restart);
setupControl("methods", restart);
setupControl("summary", restart);
reloadData(activeLabel("sports"), activeLabel("methods"), activeLabel("summary"));
