...
d3.json("/data/olympics.total.langs.json", function(totalLangCounts) {
    ...
    setupControl("sports", load);

    d3.select("#sports #" + totalLangCounts[0].key).attr("class", "active");
...
function loadTagCloud(sport) {
    clearsvg("#tagCloud");
    setupCloudSvg();
    var countFile = "/data/olympics." + sport + ".tags.json";
...
function loadGlobe(sport) {
    clearsvg("#globe");
    setupsvg();
    var langFile = "/data/olympics." + sport + ".langs.json";
